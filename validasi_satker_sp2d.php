		...
		<div class="col-md-8">
			<div class="tile">
				...
				<div class="tile-body">
					<?php 
					$id = $_GET['id'];
					$query = mysqli_query($db,"SELECT * FROM sp2d WHERE id_sp2d = '$id'");
					while ($data = mysqli_fetch_array($query)) { 
						?>  
						<form method="post" action="validasi_satker_sp2d_act.php" >
							<fieldset>

								<input type="hidden" name="id" value="<?php echo $data['id_sp2d'] ?>" />
